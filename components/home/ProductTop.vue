<!-- <template>
  <section
    ...
    class="
      ...
      overflow-hidden
      section-welcome
      bg-cover bg-no-repeat bg-center bg-[url('/banner/bg-product-top.png')]
      pt-20
    "
  >
    <div class="container mx-auto relative z-10 h-full flex items-end justify-center pb-10">
      <div
        ...
        :class="
          showAssets
            ? `extra bg-[url('/banner/bg-product-info-extra.png')]`
            : `bg-[url('/banner/bg-product-info.png')]`
        "
      >
        ...
        <div
          ...
          class="
            ...
            lg:bg-[url('/banner/bg-product-assets.svg')]
            leading-tight
            text-white
            px-3

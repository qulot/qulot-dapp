<template>
  <section>
    <div class="container mx-auto">
      <TitleCard :title="$t('home.howItWorks')" tag="a" :title-props="{ href: '#how-it-works' }">
        <template #icon>
    ...
    <div class="container mx-auto">
      <div class="grid gap-4 lg:grid-cols-2 lg:gap-8">
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/kt733JgGnmM" title="YouTube video player"
          frameborder="0"
...
const steps = computed(() => [
  {
    step: 1,
    text: t("home.step1"),
    img: "/work/step1Icon.svg"
  },
  {
    step: 2,
    text: t("home.step2"),
    img: "/work/step2Icon.svg"
  },
  {
    step: 3,
    text: t("home.step3"),
    img: "/work/step3Icon.svg"
  }
])
</script>

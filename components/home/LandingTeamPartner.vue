    ...
    <div class="container mx-auto text-sm">
      ...
      <div class="mb-6 space-y-5">
        ...
        <p class="text-black">
          ...
          khách hàng và hoạch định chiến lược.
        </p>
      </div>

      <div
        class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:gap-4 xl:gap-6 lg:grid-cols-6"
      >
        <div
          v-for="(member, index) in listMember"
          :key="`team-${index}`"
          class="flex flex-col items-center pt-8 px-4 pb-6 cursor-pointer rounded hover:bg-[#F3F3F3] hover:dark:bg-block text-center dark:text-white"
        >
          <div class="mb-5 h-20 w-20 rounded-full overflow-hidden">
            <img
              :src="member.image"
              :alt="member.name"
          ...
          <h2 class="font-bold text-title text-[17px] mb-1.5">
            {{ member.name }}
          </h2>
...
const listMember = ref([
  ...
  {
    name: 'Andy Nguyen',
    image: '/team/andy2.png',
    position: 'CTO',
  },
  {
    name: 'Andy Nguyen',
    image: '/team/andy3.png',
    position: 'PM',
  },
  {
    name: 'Andy Nguyen',
    image: '/team/andy4.png',
    position: 'Designer',
  },
  {
    name: 'Andy Nguyen',
    image: '/team/andy5.png',
    position: 'DEV',
  },
  {
    name: 'Andy Nguyen',
